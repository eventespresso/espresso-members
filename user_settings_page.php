	...
	<div id="poststuff" class="metabox-holder has-right-sidebar">
		...
		<?php #### metabox #### ?>
					<div class="metabox-holder">
						...
						<h3 class="hndle"><?php _e('Member Settings', 'event_espresso'); ?></h3>
						<div class="inside">
							<div class="padding">
								<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
									<table class="form-table">
										<tbody>
											<tr>
												<th>
													<label><?php _e('Login page (if different from default Wordpress login page): ', 'event_espresso'); ?></label> 
												</th>
												<td>
													<input type="text" name="login_page" size="25" <?php echo (isset($login_page) ? 'value="' . $login_page . '"' : "") ?> />
												</td>
											</tr>
											...
											<tr>
												<td colspan="2">
													<p class="updated" style="width:65%"><?php _e('New user registration is currently closed. If you would like to set a custom user regsistration page, you must enable "Anyone can register" in your Wordpress "<a href="options-general.php">General Settings</a>" page.', 'event_espresso') ?></p>
												</td>
											</tr>										
											<?php  
											} else {?>
											<tr>
												<th>
													<label><?php _e('Member registration page (if different from default Wordpress register page): ', 'event_espresso'); ?></label>
												</th>
												<td>
													<input name="register_page" size="25" <?php echo (isset($register_page) ? 'value="' . $register_page . '"' : "") ?> />
												</td>
											</tr>
											<?php 
											} ?>			
